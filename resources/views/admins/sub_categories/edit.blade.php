...
<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header text-primary">Edit Sub-Category Content</h3>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <form role="form" method="post" action="{{ route('admins.sub-category.update',['id'=>$sub_category->id])}}" enctype="multipart/form-data">
                                    	{{ csrf_field() }}
                                        ...
                                        <div class="form-group">
                                            ...
                                            @foreach($categories as $category)
                                                <option value="{{$category->id}}" @if($category->id==$sub_category->category_id) {{'selected'}} @endif >
                                                {{  $category->title }}
                                                </option>
                                            @endforeach    
                                            </select>
                                        ...
                                        <div class="form-group">
                                            <label>Edit Sub-Category Title</label>
                                            <input class="form-control" value="{{$sub_category->title}}"  name="title"  required>
                                            @if($errors->has('title'))

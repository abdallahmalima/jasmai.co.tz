...
<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header text-primary">Add New Category Content</h3>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <form role="form" method="post" action="{{ route('admins.category.store')}}" enctype="multipart/form-data">
                                    	{{ csrf_field() }}
                                        <div class="form-group">
                                            <label>Select Category Image 1900x600 Pixels</label>
                                        ...
                                        <div class="form-group">
                                            <label>Enter Category Desciption</label>
